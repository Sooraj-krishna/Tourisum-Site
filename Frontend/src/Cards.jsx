        ...
        <>
            <section id='card'>
                <div className="container">
                    ...
                    onClick={() => window.open('https://en.wikipedia.org/wiki/Munnar', '_blank')}
                    >
                    ...
                    onClick={() => window.open('https://en.wikipedia.org/wiki/Alappuzha', '_blank')}>
                        <div className="content">
                    ...
                    onClick={() => window.open('https://en.wikipedia.org/wiki/Thekkady', '_blank')}>
                        <div className="content">
                            <h3>Thekkady</h3>
                    ...
                    onClick={() => window.open('https://en.wikipedia.org/wiki/Kochi', '_blank')}>
                        <div className="content">
                            <h3>Kochi</h3>
                    ...
                    onClick={() => window.open('https://en.wikipedia.org/wiki/Wayanad', '_blank')}>
                        <div className="content">
                            <h3>Wayanad</h3>
                    ...
                    onClick={() => window.open('https://en.wikipedia.org/wiki/Kovalam', '_blank')}>
                        <div className="content">
                            <h3>Kovalam</h3>
